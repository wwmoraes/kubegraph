...
func (adapter adapterRbacV1RoleBinding) Create(kgraph KubeGraph, obj k8sruntime.Object) (*cgraph.Node, error) {
...
func (adapter adapterRbacV1RoleBinding) Connect(kgraph KubeGraph, source *cgraph.Node, targetName string) (*cgraph.Edge, error) {
	return kgraph.linkNode(source, adapter.GetType(), targetName)
}

func (adapter adapterRbacV1RoleBinding) Configure(kgraph KubeGraph) error {
