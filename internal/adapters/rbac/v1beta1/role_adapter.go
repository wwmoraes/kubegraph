...
// RoleObject alias for rbacV1beta1.Role
type RoleObject = rbacV1beta1.Role

// RoleAdapterObjectType reflected type of *rbacV1beta1.Role
var RoleAdapterObjectType = reflect.TypeOf((*rbacV1beta1.Role)(nil))
...
// RoleAdapter implements an adapter for rbacV1beta1.Role
type RoleAdapter struct {
	registry.Adapter
}

// CastObject casts a runtime.Object to *rbacV1beta1.Role
func (this *RoleAdapter) CastObject(obj registry.RuntimeObject) (*rbacV1beta1.Role, error) {
...
// GetGraphObjects returns a map of all *rbacV1beta1.Role
// nodes stored on a graph
func (this *RoleAdapter) GetGraphObjects(statefulGraph registry.StatefulGraph) (map[string]*rbacV1beta1.Role, error) {
	objects, err := statefulGraph.GetObjects(RoleAdapterObjectType)
	if err != nil {
		return nil, err
	}

	castedObjects := make(map[string]*rbacV1beta1.Role, len(objects))
	for key, object := range objects {
		casted, ok := object.(*rbacV1beta1.Role)
		if !ok {
...
// GetGraphNode returns the node value representing a *rbacV1beta1.Role
