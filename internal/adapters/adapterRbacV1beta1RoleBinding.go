...
func init() {
	RegisterResourceAdapter(&adapterRbacV1beta1RoleBinding{
		Resource{
			resourceType: reflect.TypeOf(&rbacV1beta1.RoleBinding{}),
		},
	})
}

func (adapter adapterRbacV1beta1RoleBinding) tryCastObject(obj runtime.Object) (*rbacV1beta1.RoleBinding, error) {
...
func (adapter adapterRbacV1beta1RoleBinding) Create(statefulGraph StatefulGraph, obj runtime.Object) (*cgraph.Node, error) {
...
func (adapter adapterRbacV1beta1RoleBinding) Connect(statefulGraph StatefulGraph, source *cgraph.Node, targetName string) (*cgraph.Edge, error) {
	return statefulGraph.LinkNode(source, adapter.GetType(), targetName)
}

// Configure connects the resources on this adapter with its dependencies
func (adapter adapterRbacV1beta1RoleBinding) Configure(statefulGraph StatefulGraph) error {
